...
const images = [
    'https://uno.kg/_next/image?url=https%3A%2F%2Fapi.uno.kg%2Fmedia%2Fbarcode%2Fa2134d44-0534-4e80-9234-ad648879846e.jpg&w=256&q=75',
    'https://uno.kg/_next/image?url=https%3A%2F%2Fapi.uno.kg%2Fmedia%2Fbarcode%2Fa2134d44-0534-4e80-9234-ad648879846e.jpg&w=256&q=75',
    'https://uno.kg/_next/image?url=https%3A%2F%2Fapi.uno.kg%2Fmedia%2Fbarcode%2Fa2134d44-0534-4e80-9234-ad648879846e.jpg&w=256&q=75',
    'https://uno.kg/_next/image?url=https%3A%2F%2Fapi.uno.kg%2Fmedia%2Fbarcode%2Fa2134d44-0534-4e80-9234-ad648879846e.jpg&w=256&q=75',
]
...
const AirСonditionerDetails = () => {
    ...
    const { id, category, sizes, title, description,sellingPrice } = data.barcode;
  ...
  return (
    ...
    <div className={styles.image__viewer}>
      ...
      <div className={styles.large__imageContainer}>
        <img src={selectedImage} alt="selected" className={styles.large__image} />
      </div>
    </div>
    ...
    <div>
        ...
        <a href="#" className={styles.characteristic}>Смотреть характеристики</a>
    </div>
        <div className={styles.cart}>
            <p>{sellingPrice} сом <span>59 500 сом</span></p>
